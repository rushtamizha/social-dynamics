...
//               <button className=" items-center hidden justify-center gap-2 px-8 py-5 bg-white border border-slate-200 text-slate-900 rounded-2xl font-bold text-lg hover:border-slate-900 transition-all">
//                 View Portfolio
//                 <ArrowRight size={20} />
//               </button>
//             </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <button className="hidden items-center justify-center gap-2 px-8 py-5 bg-white border border-slate-200 text-slate-900 rounded-2xl font-bold text-lg hover:border-slate-900 transition-all">
                View Portfolio
                <ArrowRight size={20} />
              </button>
            </motion.div>
